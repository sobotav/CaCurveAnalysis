...
inputParams.windowFirstMaximum      = [400,700];        % where to search for the first maximum
inputParams.longestTimeToPeak       = 600;              % longest time to peak
inputParams.thirdSlopeStart         = 750;              % third slope start time
inputParams.thirdSlopeEnd           = 900;              % third slope end time
